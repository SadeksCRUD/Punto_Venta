...
<body>
    ...
    <div class="text-center">
        <div class="row mt-5">
            <div class="col-12">
                <h2 class="mb-3" style="color: black;">Bienvenidos a la interfaz gráfica de Usuarios</h2>
    ...
    <div class="row mt-3">
        <div class="col-12 text-center"> <!-- Alineación a la izquierda -->
            <a href="views/registro_usuario.php" style="width: 12%;" class="btn btn-primary">Agregar Usuario</a>
        </div>
    </div>
