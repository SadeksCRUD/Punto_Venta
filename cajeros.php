...
<body>
    ...
    <!--MOSTRAR DATOS DEL cajero LOGUEADO-->
    <div class="navbar">
        <div class="dropdown">
...
<!--//////////////////////////////////////////////////-->
    ...
    <div class="admin-panel">
        <h2>CAJERO</h2>
        <br>
        <button onclick="location.href='principal_cajeros.php?controller=Producto&action=listar'">Hacer Venta</button>
        <button onclick="location.href='principal_cajeros.php?controller=Venta&action=mostrar'">Historial Ventas</button>
        </div>
